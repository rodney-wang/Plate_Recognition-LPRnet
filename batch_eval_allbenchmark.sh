...
echo "### Testing 4k benchmark " | tee -a $LOG_FILE
...
echo "### Testing hongkong benchmark " | tee -a $LOG_FILE
...
echo "### Testing new energy benchmark " | tee -a $LOG_FILE
...
echo "### Testing k11 entrance benchmark " | tee -a $LOG_FILE
...
echo "### Testing difficult plate benchmark " | tee -a $LOG_FILE
